...
class SecureStorageService implements StorageService {
  ...
  Future<void> write({
    ...
    try {
      ...
      throw LocalStorageException(message: 'Failed to write to storage', data: e);
    }
  }
  ...
  Future<String?> read({required String key}) async {
    try {
      ...
      throw LocalStorageException(message: 'Failed to read from storage', data: e);
    }
  }
  ...
  Future<void> delete({required String key}) async {
    try {
      ...
      throw LocalStorageException(message: 'Failed to delete from storage', data: e);
    }
  }
  ...
  Future<void> clearAll() async {
    try {
      ...
      throw LocalStorageException(message: 'Failed to clear storage', data: e);
    }
  }
