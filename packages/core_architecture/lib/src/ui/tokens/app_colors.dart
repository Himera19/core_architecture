...
final class AppColors {
  ...
  // BRAND — dark mode
  // Lighter tones, because the same Blue-600 does not carry enough contrast
  // against a Slate-950 surface.
  static const Color primaryDark = Color(0xFF60A5FA); // Blue-400
  static const Color onPrimaryDark = Color(0xFF1E3A8A); // Blue-900
